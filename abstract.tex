...
We also investigate a strong baselines for speeding up R-CNN, including a novel approximation to R-CNN that uses a feature pyramid to amortize region computation.
